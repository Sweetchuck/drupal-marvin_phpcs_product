...
namespace Drupal\Tests\marvin_phpcs_product\Helper;
...
class ComposerScripts {
  ...
  protected string $projectNameSnake = 'marvin_phpcs_product';

  protected string $projectNameDash = 'marvin-phpcs-product';
          ...
          'drush' => [
            'paths' => [
              'config' => [
                ...
                "\${drush.vendor-dir}/../{$this->projectRoot}/drush/Commands/contrib/marvin_phpcs/Commands/drush.yml",
              ...
              'include' => [
                ...
                "\${drush.vendor-dir}/../{$this->projectRoot}/drush/Commands/contrib/marvin_phpcs",
